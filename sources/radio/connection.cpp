...
Connection::Connection(std::shared_ptr<gr::top_block> tb, Block src, Block dst, const int index1, const int index2) : m_tb(tb), m_src(src), m_dst(dst), m_index1(index1), m_index2(index2) {
